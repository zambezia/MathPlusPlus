...
public class CalculatorConstants {
	...
	public static String[] OPERATORS = {PLUS, MINUS, MULTIPLY, DIVIDE, NEGATION, MOD, LEFT_PARAN,
		...
		POWER_10, POWER_e, NCR, NPR, AND, OR, XOR, NOT, ABS, INV};
